		...
		<div>
			<table class="table">
				...
				<ul class="pagination">
				    ...
				    <li>
				        <a href='<c:url value="/board/brag${pageMaker.makeQueryPage(pageNum) }"/>'><i class="fa">${pageNum }</i></a>
				    </li>
				    </c:forEach>
				    <c:if test="${pageMaker.next && pageMaker.endPage >0 }">
				    <li>
				        <a href='<c:url value="/board/brag${pageMaker.makeQueryPage(pageMaker.endPage+1) }"/>'><i class="fa-solid fa-chevron-right"></i></a>
				    </li>
				    </c:if>
				</ul>
	</div>
