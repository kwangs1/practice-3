...
<div class="container">
	   <div class="header">
        ...
        <p>조회 할 계정의 등록된 닉네임, 이메일이 같아야 합니다.</p>
        
	<div class='search'>
        <div class="textForm">닉네임
            <input type="text" name="nickname"  class="nickname_input" placeholder="닉네임을 입력해주세요.">
        </div>
...
function pwSearch(){
	location.href = '${path}/member/pwSearch'
}
</script>
</body>
</html>